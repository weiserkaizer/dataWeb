/* compact [
	prive/javascript/jquery.js?1531294950
	prive/javascript/jquery-migrate-3.0.1.js?1531294950
	prive/javascript/jquery.form.js?1531294950
	prive/javascript/jquery.autosave.js?1531294950
	prive/javascript/jquery.placeholder-label.js?1531294950
	prive/javascript/ajaxCallback.js?1531294950
	prive/javascript/js.cookie.js?1531294950
	prive/javascript/jquery.cookie.js?1531294950
	plugins-dist/jquery_ui/prive/javascript/ui/jquery-ui.js?1531294977
	plugins-dist/mediabox/javascript/jquery.colorbox.js?1531294983
	plugins-dist/mediabox/javascript/spip.mediabox.js?1531294983
	plugins-dist/porte_plume/javascript/jquery.markitup_pour_spip.js?1531294974
	plugins-dist/porte_plume/javascript/jquery.previsu_spip.js?1531294974
	local/cache-js/jsdyn-javascript_porte_plume_start_js-a635056a.js?1533998934
	plugins/auto/boutonstexte/v2.0.6/javascript/boutonstexte.js
	plugins/auto/ancresdouces/v1.5.1/js/jquery.scrollto.js
	plugins/auto/ancresdouces/v1.5.1/js/jquery.localscroll.js
	plugins/auto/inserer_modeles/v1.3.3/javascript/autosize.min.js
	plugins/auto/slick/v1.2.7/lib/slick/slick.min.js
	local/cache-js/jsdyn-javascript_slick_spip_js-ee5d27b6.js?1533998934
	plugins/auto/soyezcreateurs/v4.3.16/javascript/jquery.em.js?1532611439
	plugins/auto/soyezcreateurs/v4.3.16/javascript/jquery-accessible-modal-window-aria/jquery-accessible-modal-window-aria.js?1532611439
] 63.3% */
...
,{"name":"Insérer un modèle","key":"M","className":"outil_inserer_modeles separateur separateur_apres sepInsMod separateur_avant","beforeInsert":function(){jQuery.modalboxload('http://localhost/spip.php?page=inserer_modeles&modalbox=oui&id_article='+$("[name='id_article']").val()+'&id_rubrique='+$("[name='id_rubrique']").val()+'&id_breve='+$("[name='id_breve']").val(),{minHeight:'90%'});},"dropMenu":[{"id":"inserer_modele_definition","name":"Une définition","className":"outil_inserer_modele_definition","beforeInsert":function(){jQuery.modalboxload('http://localhost/spip.php?page=inserer_modeles&modalbox=oui&formulaire_modele=definition&id_article='+$("[name='id_article']").val()+'&id_rubrique='+$("[name='id_rubrique']").val()+'&id_breve='+$("[name='id_breve']").val(),{minHeight:'90%'});},"display":true}
,{"id":"inserer_modele_carte_gis","name":"Un point géolocalisé","className":"outil_inserer_modele_carte_gis","beforeInsert":function(){jQuery.modalboxload('http://localhost/spip.php?page=inserer_modeles&modalbox=oui&formulaire_modele=carte_gis&id_article='+$("[name='id_article']").val()+'&id_rubrique='+$("[name='id_rubrique']").val()+'&id_breve='+$("[name='id_breve']").val(),{minHeight:'90%'});},"display":true}
,{"id":"inserer_modele_media","name":"un document","className":"outil_inserer_modele_media","beforeInsert":function(){jQuery.modalboxload('http://localhost/spip.php?page=inserer_modeles&modalbox=oui&formulaire_modele=media&id_article='+$("[name='id_article']").val()+'&id_rubrique='+$("[name='id_rubrique']").val()+'&id_breve='+$("[name='id_breve']").val(),{minHeight:'90%'});},"display":true}
]
}
,{"name":"Changement de langue dans le texte (<multi>[langue]...</multi>).","className":"outil_changement_langue separateur separateur_apres sepChgtLang","openWith":"<multi>[[![Indiquez le code de la nouvelle langue (par exemple : fr pour le français, en pour l'anglais).]!]]","closeWith":"</multi>"}
]
}
