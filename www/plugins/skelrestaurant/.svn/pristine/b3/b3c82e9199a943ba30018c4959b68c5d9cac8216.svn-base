 ...
 * @return void
**/
function sc_mammaskitchen_upgrade($nom_meta_base_version, $version_cible) {
	$maj = array();
	
	$maj['create'] = array(
		array('scmamma_noisettespardefaut')
	);
 ...
 * @return void
**/
function sc_mammaskitchen_vider_tables($nom_meta_base_version) {
	effacer_meta($nom_meta_base_version);
}

function scmamma_noisettespardefaut() {
