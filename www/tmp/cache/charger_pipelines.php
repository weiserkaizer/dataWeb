...
include_once_check(_ROOT_PLUGINS.'auto/compositions/v3.7.3/compositions_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v2.26.5/saisies_pipelines.php');
$inc=true;
}
...
include_once_check(_ROOT_PLUGINS.'auto/agenda/v3.19.6/agenda_pipelines.php');
$inc=true;
}
...
$val = minipipe('mailcrypt_affichage_final', $val);
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/gis/v4.44.19/gis_pipelines.php');
$inc=true;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'organiseur/organiseur_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/inserer_modeles/v1.3.3/inserer_modeles_pipelines.php');
$inc=true;
}
$val = minipipe('compagnon_affiche_droite', $val);
$val = minipipe('organiseur_affiche_droite', $val);
$val = minipipe('inserer_modeles_affiche_droite', $val);
return $val;
}
...
$val = minipipe('savecfg_afficher_tout', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'medias/medias_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/agenda/v3.19.6/agenda_pipelines.php');
include_once_check(_ROOT_PLUGINS.'noizetier/noizetier_pipelines.php');
$inc=true;
}
...
$val = minipipe('noizetier_affiche_milieu', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'auto/fulltext/v1.2.0/fulltext_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/agenda/v3.19.6/agenda_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/menus/v1.6.11/inc/menus_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/gis/v4.44.19/gis_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/ieconfig/v1.3.2/ieconfig_autoriser.php');
include_once_check(_ROOT_PLUGINS.'noizetier/noizetier_autorisations.php');
include_once_check(_ROOT_PLUGINS.'auto/dictionnaires/v1.1.11/dictionnaires_autoriser.php');
$inc=true;
}
...
$val = minipipe('fulltext_autoriser', $val);
$val = minipipe('agenda_autoriser', $val);
$val = minipipe('menus_autoriser', $val);
$val = minipipe('gis_autoriser', $val);
$val = minipipe('ieconfig_autoriser', $val);
$val = minipipe('noizetier_autoriser', $val);
$val = minipipe('dictionnaires_autoriser', $val);
return $val;
}
...
$val = minipipe('noizetier_boite_infos', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'auto/agenda/v3.19.6/base/agenda_evenements.php');
include_once_check(_ROOT_PLUGINS.'auto/menus/v1.6.11/base/menus_tables.php');
include_once_check(_ROOT_PLUGINS.'auto/gis/v4.44.19/base/gis.php');
include_once_check(_ROOT_PLUGINS.'noizetier/base/noizetier_tables.php');
include_once_check(_ROOT_PLUGINS.'auto/savecfg/v3.0.7/base/savecfg_install.php');
include_once_check(_ROOT_PLUGINS.'auto/dictionnaires/v1.1.11/base/dictionnaires_tables.php');
include_once_check(_ROOT_PLUGINS.'auto/oembed/v2.0.7/oembed_pipelines.php');
$inc=true;
}
...
$val = minipipe('noizetier_declarer_tables_interfaces', $val);
$val = minipipe('savecfg_declarer_tables_interfaces', $val);
$val = minipipe('dictionnaires_declarer_tables_interfaces', $val);
...
include_once_check(_ROOT_PLUGINS_DIST.'sites/base/sites.php');
include_once_check(_ROOT_PLUGINS_DIST.'svp/base/svp_declarer.php');
include_once_check(_ROOT_PLUGINS.'auto/notifications/v3.6.7/notifications_administrations.php');
include_once_check(_ROOT_PLUGINS.'auto/compositions/v3.7.3/compositions_pipeline.php');
include_once_check(_ROOT_PLUGINS_DIST.'breves/base/breves.php');
include_once_check(_ROOT_PLUGINS_DIST.'medias/base/medias.php');
include_once_check(_ROOT_PLUGINS.'auto/fulltext/v1.2.0/base/fulltext.php');
include_once_check(_ROOT_PLUGINS.'auto/agenda/v3.19.6/base/agenda_evenements.php');
include_once_check(_ROOT_PLUGINS.'auto/gis/v4.44.19/base/gis.php');
include_once_check(_ROOT_PLUGINS.'auto/dictionnaires/v1.1.11/base/dictionnaires_tables.php');
$inc=true;
...
$val = minipipe('notifications_declarer_tables_objets_sql', $val);
...
$val = minipipe('fulltext_declarer_tables_objets_sql', $val);
$val = minipipe('agenda_declarer_tables_objets_sql', $val);
$val = minipipe('gis_declarer_tables_objets_sql', $val);
$val = minipipe('dictionnaires_declarer_tables_objets_sql', $val);
return $val;
}
...
$val = minipipe('noizetier_declarer_tables_principales', $val);
$val = minipipe('savecfg_declarer_tables_principales', $val);
return $val;
}
...
$val = minipipe('dictionnaires_declarer_tables_auxiliaires', $val);
return $val;
}
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/menus/v1.6.11/menus_pipelines.php');
$inc=true;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'revisions/inc/revisions_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/nospam/v1.5.18/nospam_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v2.26.5/saisies_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/gisgeom/v1.11.5/gisgeom_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/oembed/v2.0.7/oembed_pipelines.php');
$inc=true;
}
...
$val = minipipe('gisgeom_formulaire_charger', $val);
...
$val = minipipe('gisgeom_formulaire_verifier', $val);
return $val;
}
...
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/nospam/v1.5.18/nospam_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/facteur/v3.5.2/facteur_pipelines.php');
$inc=true;
}
...
$val = minipipe('noizetier_formulaire_admin', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'organiseur/organiseur_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'porte_plume/porte_plume_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/typoenluminee/v3.5.12/typoenluminee_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/pp_chgt_lg/v0.3.2/pp_chgt_lg_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/citations_bb/v0.1.4/citations_bb_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/crayons/v1.26.17/crayons_fonctions.php');
include_once_check(_ROOT_PLUGINS_DIST.'compresseur/compresseur_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v2.26.5/saisies_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/menus/v1.6.11/menus_pipelines.php');
...
$val = minipipe('typoenluminee_header_prive', $val);
$val = minipipe('pp_chgt_lg_header_prive', $val);
$val = minipipe('citations_bb_header_prive', $val);
...
$val = minipipe('inserer_modeles_header_prive', $val);
$val = minipipe('gis_header_prive', $val);
$val = minipipe('gisgeom_header_prive', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'auto/typoenluminee/v3.5.12/typoenluminee_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/citations_bb/v0.1.4/citations_bb_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/boutonstexte/v2.0.6/boutonstexte_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/ancresdouces/v1.5.1/ancres_douces_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'compresseur/compresseur_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/inserer_modeles/v1.3.3/inserer_modeles_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/gis/v4.44.19/gis_pipelines.php');
include_once_check(_ROOT_PLUGINS.'noizetier/noizetier_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/slick/v1.2.7/slick_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/oembed/v2.0.7/oembed_pipelines.php');
$inc=true;
}
...
$val = minipipe('typoenluminee_insert_head', $val);
$val = minipipe('citations_bb_insert_head', $val);
$val = minipipe('boutonstexte_insert_head', $val);
$val = minipipe('ancresdouces_insert_head', $val);
$val = minipipe('compresseur_insert_head', $val);
$val = minipipe('inserer_modeles_insert_head', $val);
$val = minipipe('gis_insert_head', $val);
$val = minipipe('noizetier_insert_head_css', $val);
$val = minipipe('slick_insert_head', $val);
...
$val = minipipe('typoenluminee_insert_head_css', $val);
$val = minipipe('typo_guillemets_insert_head_css', $val);
$val = minipipe('orthotypo_insert_head_css', $val);
$val = minipipe('boutonstexte_insert_head_css', $val);
$val = minipipe('agenda_insert_head_css', $val);
$val = minipipe('gis_insert_head_css', $val);
$val = minipipe('gisgeom_insert_head_css', $val);
$val = minipipe('noizetier_insert_head_css', $val);
$val = minipipe('slick_insert_head_css', $val);
$val = minipipe('oembed_insert_head_css', $val);
return $val;
}
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/typoenluminee/v3.5.12/typoenluminee.php');
$inc=true;
}
$val = minipipe('typoenluminee_nettoyer_raccourcis_typo', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'auto/notifications/v3.6.7/notifications_pipelines.php');
$inc=true;
}
$val = minipipe('forum_notifications', $val);
$val = minipipe('notifications_go', $val);
return $val;
}
...
$val = minipipe('gisgeom_pre_boucle', $val);
$val = minipipe('noizetier_pre_boucle', $val);
return $val;
}
...
$val = minipipe('typoenluminee_pre_propre', $val);
$val = minipipe('orthotypo_pre_propre', $val);
$val = minipipe('citations_bb_pre_propre', $val);
...
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/typoenluminee/v3.5.12/typoenluminee.php');
include_once_check(_ROOT_PLUGINS.'auto/accessibilite/v2.0.3/accessibilite_pipelines.php');
...
$val = minipipe('typoenluminee_pre_liens', $val);
$val = minipipe('Accessibilite_pre_liens', $val);
...
include_once_check(_ROOT_PLUGINS.'auto/typoenluminee/v3.5.12/typoenluminee.php');
include_once_check(_ROOT_PLUGINS.'auto/mailcrypt/v2.4.5/mailcrypt_fonctions.php');
include_once_check(_ROOT_PLUGINS.'auto/dictionnaires/v1.1.11/dictionnaires_pipelines.php');
$inc=true;
}
$val = minipipe('typoenluminee_post_propre', $val);
$val = minipipe('mailcrypt_post_propre', $val);
$val = minipipe('dictionnaires_post_propre', $val);
return $val;
}
// Pipeline pre_typo 
...
$val = minipipe('typoenluminee_pre_typo', $val);
return $val;
}
// Pipeline post_typo 
...
$val = minipipe('typoenluminee_post_typo', $val);
$val = minipipe('typo_guillemets_remplacements', $val);
$val = minipipe('orthotypo_post_typo', $val);
...
$val = minipipe('gisgeom_pre_insertion', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'auto/notifications/v3.6.7/notifications_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/fulltext/v1.2.0/fulltext_pipelines.php');
$inc=true;
}
...
$val = minipipe('notifications_taches_generales_cron', $val);
$val = minipipe('fulltext_taches_generales_cron', $val);
return $val;
}
...
$val = minipipe('gisgeom_recuperer_fond', $val);
$val = minipipe('noizetier_recuperer_fond', $val);
...
include_once_check(_ROOT_PLUGINS.'auto/fabrique/v2.3.12/fabrique_pipelines.php');
include_once_check(_ROOT_PLUGINS.'noizetier/noizetier_pipelines.php');
$inc=true;
}
$val = minipipe('compagnon_compagnon_messages', $val);
$val = minipipe('fabrique_compagnon_messages', $val);
$val = minipipe('noizetier_compagnon_messages', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'auto/facteur/v3.5.2/facteur_ieconfig_metas.php');
include_once_check(_ROOT_PLUGINS.'auto/compositions/v3.7.3/compositions_ieconfig.php');
...
include_once_check(_ROOT_PLUGINS.'auto/menus/v1.6.11/menus_ieconfig.php');
include_once_check(_ROOT_PLUGINS.'auto/ieconfig/v1.3.2/ieconfig_pipelines.php');
$inc=true;
}
...
$val = minipipe('ieconfig_ieconfig_metas', $val);
return $val;
}
...
$val = minipipe('noizetier_jqueryui_forcer', $val);
return $val;
}
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/typoenluminee/v3.5.12/enluminures_typo_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/pp_chgt_lg/v0.3.2/pp_chgt_lg_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/inserer_modeles/v1.3.3/inserer_modeles_pipelines.php');
$inc=true;
}
$val = minipipe('typoenluminee_porte_plume_barre_pre_charger', $val);
$val = minipipe('pp_chgt_lg_porte_plume_barre_pre_charger', $val);
$val = minipipe('inserer_modeles_porte_plume_barre_pre_charger', $val);
return $val;
}
...
$val = minipipe('typoenluminee_porte_plume_lien_classe_vers_icone', $val);
$val = minipipe('pp_chgt_lg_porte_plume_lien_classe_vers_icone', $val);
$val = minipipe('inserer_modeles_porte_plume_lien_classe_vers_icone', $val);
return $val;
}
...
$val = minipipe('mailcrypt_facteur_pre_envoi', $val);
return $val;
}
...
$val = minipipe('notifications_notifications_destinataires', $val);
return $val;
}
...
$val = minipipe('corbeille_corbeille_table_infos', $val);
...
$val = minipipe('noizetier_compositions_lister_disponibles', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS.'auto/menus/v1.6.11/menus_ieconfig.php');
include_once_check(_ROOT_PLUGINS.'auto/ieconfig/v1.3.2/ieconfig_pipelines.php');
include_once_check(_ROOT_PLUGINS.'noizetier/noizetier_ieconfig.php');
$inc=true;
}
$val = minipipe('menus_ieconfig', $val);
$val = minipipe('ieconfig_ieconfig', $val);
$val = minipipe('noizetier_ieconfig', $val);
return $val;
}
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/ieconfig/v1.3.2/ieconfig_mes_fichiers_a_sauver.php');
$inc=true;
}
$val = minipipe('ieconfig_mes_fichiers_a_sauver', $val);
return $val;
}
// Pipeline noizetier_lister_pages 
function execute_pipeline_noizetier_lister_pages(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'noizetier/noizetier_pipelines.php');
$inc=true;
}
$val = minipipe('noizetier_noizetier_lister_pages', $val);
return $val;
}
// Pipeline noizetier_blocs_defaut 
function execute_pipeline_noizetier_blocs_defaut(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'noizetier/noizetier_pipelines.php');
$inc=true;
}
$val = minipipe('noizetier_noizetier_blocs_defaut', $val);
return $val;
}
// Pipeline noizetier_config_export 
function execute_pipeline_noizetier_config_export(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'noizetier/noizetier_pipelines.php');
$inc=true;
}
$val = minipipe('noizetier_noizetier_config_export', $val);
return $val;
}
// Pipeline noizetier_config_import 
function execute_pipeline_noizetier_config_import(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'noizetier/noizetier_pipelines.php');
$inc=true;
}
$val = minipipe('noizetier_noizetier_config_import', $val);
return $val;
}
// Pipeline lister_definitions 
function execute_pipeline_lister_definitions(&$val){
return $val;
}
