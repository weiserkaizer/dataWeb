...
function BOUCLE_menusoushtml_2957bc4a42d793f30a2a11cbdc1ff47a(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/menu-navigation.html','html_2957bc4a42d793f30a2a11cbdc1ff47a','_menusous',9,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
function BOUCLE_menuhtml_2957bc4a42d793f30a2a11cbdc1ff47a(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/squelettes/inclure/menu-navigation.html','html_2957bc4a42d793f30a2a11cbdc1ff47a','_menu',3,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
'
	...
	' .
BOUCLE_menusoushtml_2957bc4a42d793f30a2a11cbdc1ff47a($Cache, $Pile, $doublons, $Numrows, $SP) .
'
	</ul>
...
// Temps de compilation total: 8.201 ms
//

function html_2957bc4a42d793f30a2a11cbdc1ff47a($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
BOUCLE_menuhtml_2957bc4a42d793f30a2a11cbdc1ff47a($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_2957bc4a42d793f30a2a11cbdc1ff47a', $Cache, $page, '../prive/squelettes/inclure/menu-navigation.html');
}
?>