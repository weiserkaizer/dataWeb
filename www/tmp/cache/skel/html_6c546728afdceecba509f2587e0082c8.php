...
function html_6c546728afdceecba509f2587e0082c8($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
	...
	'default' => interdire_scripts(sinon(table_valeur(@$Pile[0], (string)'default', null), '')) ), array('compil'=>array('prive/formulaires/menu_lang.html','html_6c546728afdceecba509f2587e0082c8','',0,$GLOBALS['spip_lang'])), _request('connect'))))!=='' ?
...
<form method="post" action="' .
	...
	return analyse_resultat_skel('html_6c546728afdceecba509f2587e0082c8', $Cache, $page, 'prive/formulaires/menu_lang.html');
}
?>