 ...
 * Date :      Wed, 11 Jul 2018 07:42:28 GMT
...
function BOUCLE_objetshtml_4ff338af175190020a7c5ca6fbda25a6(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/themes/spip/lists.css.html','html_4ff338af175190020a7c5ca6fbda25a6','_objets',78,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
function BOUCLE_objets2html_4ff338af175190020a7c5ca6fbda25a6(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$iter = IterFactory::create(
		"DATA",
		$command,
		array('../prive/themes/spip/lists.css.html','html_4ff338af175190020a7c5ca6fbda25a6','_objets2',154,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
// Temps de compilation total: 5.752 ms
//
