 ...
 * Date :      Wed, 11 Jul 2018 07:43:40 GMT
 * Compile :   Sat, 11 Aug 2018 14:48:48 GMT
 * Boucles :   _auteurs
 */ 

function BOUCLE_auteurshtml_a5410848f119399686a1a4911a50d21d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
quete_condition_statut('auteurs.statut','!5poubelle','!5poubelle',''), 
	...
	$iter = IterFactory::create(
		"SQL",
		$command,
		array('squelettes-dist/modeles/lesauteurs.html','html_a5410848f119399686a1a4911a50d21d','_auteurs',9,$GLOBALS['spip_lang'])
	);
	if (!$iter->err()) {
	$SP++;
	// RESULTATS
...
// Temps de compilation total: 12.581 ms
//

function html_a5410848f119399686a1a4911a50d21d($Cache, $Pile, $doublons = array(), $Numrows = array(), $SP = 0) {
...
'
' .
BOUCLE_auteurshtml_a5410848f119399686a1a4911a50d21d($Cache, $Pile, $doublons, $Numrows, $SP));

	return analyse_resultat_skel('html_a5410848f119399686a1a4911a50d21d', $Cache, $page, 'squelettes-dist/modeles/lesauteurs.html');
}
?>